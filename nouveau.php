...
<head>
  ...
  <style>
      ...
      .valid { border: 2px solid green !important; background-color: #e8f0fe; }
      .invalid { border: 2px solid red !important; background-color: #fce8e8; }
      .error-msg { color: red; font-size: 0.85em; display: none; margin-bottom: 10px; }
...
<div class="client_page">
    ...
    <div id="global-msg"></div> <form id="registerForm">
        <label>Nom :</label>
        ...
        <label>Téléphone :</label><input type="text" name="num">
...
$(document).ready(function() {
    ...
    $('#mail').on('blur', function() { // verifier quand il finit de ectir
        ...
        // ajax verifier
        $.post('check_email.php', {mail: email}, function(response) {
